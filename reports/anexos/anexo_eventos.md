...
| **20/12/2024** | **Costa / McCafé** | Aprovechamiento de la "temporada navideña" por competidores globales con promociones cruzadas mientras Starbucks se reestructura. | **Dinámica Estacional:** Mayor disputa por la atención del consumidor en el periodo de mayor consumo. | *Datos de industria QSR/Retail Cycle* |
...
| **07/04/2025** | **Luckin Coffee** | Presión continuada en China con la expansión del formato "subsidios masivos" y cupones de descuentos. | **Competencia Directa (Precio):** Forzando a SBUX a perder cuota local a cambio de proteger sus márgenes premium. | *Análisis Macroeconómico China* |
| **09/04/2025** | **Dunkin' / Costa** | Despliegue de innovaciones de primavera en el segmento RTD en puntos minoristas. | **Sustitución de CPG:** Erosión menor en los ingresos de "Channel Development" de SBUX. | *Reportes de Consumo CPG* |
...
| **21/01/2026** | **Costa Coffee / SBUX** | Avances tácticos en la guerra de máquinas expendedoras. Costa acelera penetración en espacios donde SBUX tiene licencias. | **Presión B2B:** Desafío al flujo de caja estable que Starbucks recibe de universidades y oficinas. | *Proyecciones de Industria QSR 2026* |
